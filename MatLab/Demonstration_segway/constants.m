...
t_samp = 0.00338; %295Hz sampling frequency
m = 0.550; %0.5431;   % mass of the robot
M = 0.03583;%0.1;  % mass of the wheel
L = (120/1000);%0.2;    % distance from the wheel to the center of mass
r = 0.028;%50e-3;  % wheel radius
J = 0.5*(M)*(r)^2;  % inertia of the wheel
...
%% The masses (Kg)
% 1.Mass of wheel + tyre balloon M:0.005543
